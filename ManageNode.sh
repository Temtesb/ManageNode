...
BASE_COMMAND="$NODE_BIN --database rocksdb --offchain-worker always --prometheus-external --base-path $HOME/subtensor/data --chain chainspecs/raw_spec_finney.json --no-mdns --bootnodes /dns/bootnode.finney.chain.opentensor.ai/tcp/30333/ws/p2p/12D3KooWRwbMb85RWnT8DSXSYMWQtuDwh4LJzndoRrTDotTR5gDC --experimental-rpc-endpoint listen-addr=0.0.0.0:9944"
